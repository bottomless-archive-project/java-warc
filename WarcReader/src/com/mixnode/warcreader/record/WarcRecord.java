...
public class WarcRecord {
  ...
  /**
   * WARC version number. 'protocol' string format is WARC/X, in which X is the version of WARC
   * record
   */
  ...
  /**
   * warcContentBlock is a base interface for all implementations of different content blocks.
   * warcContentBlock may refer to different objects base on WARC-Type
   *
   * @see type
   */
  ...
  /**
   * Returns WARC content block of a WARC record warcContentBlock is a base interface for all
   * implementations of different content blocks. Returned warcContentBlock may refer to different
  ...
  /**
   * Create a WarcRecord object and initialize WARC headers Content block of the WarcRecord is null
   *
  ...
  /**
   * Default constructor WARC headers is empty and WARC content block is null
   */
  public WarcRecord() {
    this(null, null);
  }
  ...
  /**
   * Skip remaining part of a WARC record stream. This function must be called before reading a new
   * WARC record. Content block stream will not accessible after calling this function. Best
   * practice is to call skip after finish processing of a WARC record
   */
