...
public class WarcRecordStreamFactory {
    ...
    public static Stream<WarcRecord> streamOf(@NotNull @NonNull final URL url) {
    ...
    public static Stream<WarcRecord> streamOf(@NotNull @NonNull final InputStream warcFileLocation) {
    ...
    public static Stream<WarcRecord> streamOf(@NotNull @NonNull final InputStream inputStream,
